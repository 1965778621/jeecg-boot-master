...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        // client放行
        filterChainDefinitionMap.put("/im/client/**", "anon");
        filterChainDefinitionMap.put("/cms/client/**", "anon");
        filterChainDefinitionMap.put("/callback/**", "anon");
        filterChainDefinitionMap.put("/MP_verify_dpFb6HIJbKq40dWp.txt/**", "anon");
        //测试示例
